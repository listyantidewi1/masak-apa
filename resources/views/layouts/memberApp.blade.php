        ...
        <div class="row">
            ...
            <div class="col-lg-7 p-3 text-center">
                <nav class="my-2 my-md-0 mr-md-3"">
                    <a class="p-2 text-dark text-decoration-none" href="{{ route('member.home.index') }}">Home</a>
                    {{-- <a class="p-2 text-dark text-decoration-none" href="{{ route('member.recipes.index') }}">Recipes</a> --}}
